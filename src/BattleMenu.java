...
//Print out Insrtuctiosn for player to do
        ...
        while (p1Turn == true) {
            ...
            if (userInput1 == 3) {
                ...
                if (userInput1 == 4) {
                    System.out.println("If you run it's game over are you sure?");
                    System.out.println("1. Yes " + "\n 2. No");
                    valid1 = new ValidateIntInput(1, 2);
                    if (valid1.getValue() == 1)
                        System.exit(1);


                }
                if (userInput1 == 5) {
                    BattleSituation battleSit = new BattleSituation(pokemon1, pokemon2);
                }
